...
export function DraftScopeReview({
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <Alert>
        <AlertTitle>Draft ISMS Scope - Review Required</AlertTitle>
        <AlertDescription>
          This scope was generated by the Voyu AI agent based on your intake responses.
          Please review carefully before approving. This will become the foundation of your ISMS.
        </AlertDescription>
      </Alert>
