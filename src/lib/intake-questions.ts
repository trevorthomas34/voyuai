...
export const intakeQuestions: IntakeQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'consumer_goods', label: 'Consumer Goods / CPG' },
      { value: 'manufacturing', label: 'Manufacturing' },
      { value: 'hardware', label: 'Hardware / Electronics' },
      { value: 'telecom', label: 'Telecommunications' },
      { value: 'internet', label: 'Internet / Online Platforms' },
      ...
      { value: 'research', label: 'Research / Labs / R&D' },
      { value: 'aerospace', label: 'Aerospace / Defense' },
      { value: 'agriculture', label: 'Agriculture / AgTech' },
      { value: 'web3', label: 'Web3 / Blockchain / Crypto' },
