...
export const annexAControls: ControlData[] = [
  ...
  { id: '46', control_id: 'A.7.1', name: 'Physical security perimeters', intent: 'Prevent unauthorized physical access', theme: 'physical', applicable: true, justification: null, implementation_status: 'gap' },
  { id: '47', control_id: 'A.7.2', name: 'Physical entry', intent: 'Ensure only authorized physical access', theme: 'physical', applicable: true, justification: null, implementation_status: 'gap' },
  { id: '48', control_id: 'A.7.3', name: 'Securing offices, rooms and facilities', intent: 'Prevent unauthorized access to facilities', theme: 'physical', applicable: true, justification: null, implementation_status: 'gap' },
  { id: '49', control_id: 'A.7.4', name: 'Physical security monitoring', intent: 'Detect unauthorized physical access', theme: 'physical', applicable: true, justification: null, implementation_status: 'gap' },
  { id: '50', control_id: 'A.7.5', name: 'Protecting against physical and environmental threats', intent: 'Prevent impact of physical threats', theme: 'physical', applicable: true, justification: null, implementation_status: 'gap' },
  { id: '51', control_id: 'A.7.6', name: 'Working in secure areas', intent: 'Protect information in secure areas', theme: 'physical', applicable: true, justification: null, implementation_status: 'gap' },
